...
public class UserGuideActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fxclgz= (RelativeLayout) findViewById(R.id.fxclgz);
        ...
        fxclgz.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        {
            case R.id.fxclgz:
                Intent in1=new Intent(UserGuideActivity.this,RepairActivity.class);
                startActivity(in1);
                break;
            case R.id.yjsm:
